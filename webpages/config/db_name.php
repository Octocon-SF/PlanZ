...
define("CON_NAME", "Octocon 2025");
define("CON_URL", "https://octocon.com");
...
define("CON_START_DATIM", "2025-10-10 00:00:00"); // Broadly used.  Must be in mysql format: "YYYY-MM-DD HH:MM:SS" (HH:00-23) HH:MM:SS probably should be 00:00:00
...
define("FIRST_DAY_START_TIME", "10:00"); // next 5 are for grid scheduler
define("OTHER_DAY_STOP_TIME", "26:00");
define("OTHER_DAY_START_TIME", "10:00");
define("LAST_DAY_STOP_TIME", "23:00");
...
define("DEFAULT_DURATION", "1:00"); // must correspond to DURATION_IN_MINUTES
...
define("GRID_START_DATIM", "2025-10-10 18:00:00"); // Used by special grid report
define("GRID_END_DATIM", "2025-10-12 20:00:00"); // Used by special grid report
...
define("REG_PART_PREFIX", "1"); // only needed for USE_REG_SYSTEM = FALSE; prefix portion of userid/badgeid before counter; can be empty string for no prefix
define("REG_PART_DIGITS", 3); // only needed for USE_REG_SYSTEM = FALSE; number of digits to pad counter; if number has fewer than specified digits, will left pad with zeros
...
define("JSON_EXTRACT_DIRECTORY", "/var/www/vhosts/octocon.com/prog/2025/");  // Path to directory where Konopas/ConClár files to be written.
...
define("CON_HEADER_IMG_ALT", "Octocon - The National Irish Science Fiction Convention");
...
define("REPORT_INCLUDE_DIRECTORY", "/var/www/vhosts/octocon.com/participants/reports/");  // outside of web server path, only served by PHP
